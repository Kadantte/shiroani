...
#   ./scripts/bump-version.sh patch        # auto-increment patch (0.1.0 → 0.1.1)
#   ./scripts/bump-version.sh minor        # auto-increment minor (0.1.0 → 0.2.0)
#   ./scripts/bump-version.sh major        # auto-increment major (0.1.0 → 1.0.0)
