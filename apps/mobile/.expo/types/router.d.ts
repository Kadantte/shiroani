  ...
  export namespace ExpoRouter {
    export interface __routes<T extends string | object = string> {
      hrefInputParams:
        ...
        | { pathname: `${'/(tabs)'}/browser` | `/browser`; params?: Router.UnknownInputParams }
      ...
      hrefOutputParams:
        ...
        | { pathname: `${'/(tabs)'}/browser` | `/browser`; params?: Router.UnknownOutputParams }
