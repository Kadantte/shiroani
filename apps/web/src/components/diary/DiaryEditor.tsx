...
const DIARY_GRADIENTS: Record<string, { label: string; css: string }> = {
  sakura: {
    label: 'Sakura',
...
const MOOD_OPTIONS: { value: DiaryMood; label: string; Icon: typeof Sparkles; color: string }[] = [
  { value: 'great', label: 'Świetnie', Icon: Sparkles, color: 'text-yellow-400' },
  { value: 'good', label: 'Dobrze', Icon: Heart, color: 'text-pink-400' },
  { value: 'neutral', label: 'Neutralnie', Icon: MinusIcon, color: 'text-muted-foreground' },
